...
* Description :unfold:
This module provides code completion, powered by [[https://github.com/minad/corfu][corfu]]. Either this or the
[[../company/README.org][company-mode module]] needs to be active for the "intellisense" functionality
provided by many of the [[doom-module:][:lang]] modules. Corfu is much lighter weight and focused,
...
| [[kbd:][SPC]]      | (when completing) Insert separator (see below)       |
...
be found [[https://github.com/oantolin/orderless#company][here]]. Pressing [[kbd:][SPC]] when completing does not immediately stop
completion, it goes until there are no matches or you manually back out of it.
This allows searching with space separated terms; each piece will match
individually and in any order, with smart casing.
