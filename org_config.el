...
(defun mx/well/get-arbiter-api (env)
  ...
  (let ((production-boa "https://nlb.arbiter.us-east-2.boa.ps.pro.aws.wellit.io")
    ...
    (pcase env
      ...
      ("production-platform-services-431" "https://nlb.arbiter.us-east-2.431.ps.pro.aws.wellit.io")
      ("production-platform-services-432" "https://nlb.arbiter.us-east-2.432.ps.pro.aws.wellit.io")
      ("production-platform-services-433" "https://nlb.arbiter.us-east-2.433.ps.pro.aws.wellit.io")
